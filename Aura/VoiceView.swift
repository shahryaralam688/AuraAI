            ...
            ZStack {
                ...
                if isChatMode {
                    ...
                    VStack(spacing: 0) {
                        ...
                        // Orb sits above transcription when listening; it shrinks to 40% size
                        OrbView(intensity: $intensity, currentVolume: $volume)
                            .frame(width: isListening ? 120 : 300, height: isListening ? 120 : 300)
                            ...
                            .shadow(
                                color: alabaster.opacity(0.5),
                                radius: 40,
                                x: 0,
                                y: 0
                            )
                            .animation(.spring(response: 0.5, dampingFraction: 0.8), value: isListening)
...
//                // Dismiss button positioned at top left
//                VStack {
//                    HStack {
//                        Spacer()
//                        Button(action: {
...
//                    Spacer()
//                }
//                .padding(.top, 10) // Safe area padding for status bar
//                .padding(.trailing, 16)
...
//            // Bottom control buttons
                    ...
                    Button(action: toggle) {
                        ZStack {
                            Circle()
                                ...
                                .shadow(
                                    color: isListening ? emerald.opacity(0.6) : alabaster.opacity(0.1),
    ...
    private func chatModeBottomView(geometry: GeometryProxy) -> some View {
        VStack(spacing: 0) {
            ...
            HStack(spacing: 12) {
                // Smaller voice button on the left
                Button(action: toggle) {
                    ZStack {
                        Circle()
                            .fill(
